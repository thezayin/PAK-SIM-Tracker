...
import com.thezayin.paksimdetails.framework.extension.functions.sendMail
    ...
    Column(
        ...
        Card(
            ...
            Row(
                ...
                Text(
                    text = stringResource(id = R.string.privacy_policy), // Use string resource here
                    color = colorResource(id = R.color.black),
                    fontFamily = FontFamily(Font(R.font.noto_sans_regular)),
                    fontSize = 10.ssp,
                    modifier = Modifier
        ...
        Card(
            ...
            Row(
                ...
                Text(
                    text = stringResource(id = R.string.terms_conditions), // Use string resource here
                    color = colorResource(id = R.color.black),
                    fontFamily = FontFamily(Font(R.font.noto_sans_regular)),
                    fontSize = 10.ssp,
                    modifier = Modifier
        ...
        Card(
            ...
            Row(
                ...
                Text(
                    text = stringResource(id = R.string.contact_us), // Use string resource here
                    color = colorResource(id = R.color.black),
                    fontFamily = FontFamily(Font(R.font.noto_sans_regular)),
                    fontSize = 10.ssp,
                    modifier = Modifier
